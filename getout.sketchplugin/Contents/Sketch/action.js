...
/* WEBPACK VAR INJECTION */(function(setTimeout) {Object.defineProperty(exports, "__esModule", {
  value: true
});

exports['default'] = function (context) {
  var Rectangle = _dom2['default'].Rectangle;
  ...
  function pageBasis(layer) {
    var pos1 = layer.frame.changeBasis({ from: layer });
    var pos2 = new Rectangle(pos1.x - layer.frame.x, pos1.y - layer.frame.y, layer.frame.width, layer.frame.height);
    layer.parent = page;
    layer.frame = pos2;
  }
  _ui2['default'].message("✅ Get out");
};
...
var buildWebAPI = __webpack_require__(10)
...
function BrowserWindow(options) {
  ...
  if (options.frame !== false) {
    ...
    if (options.titleBarStyle === 'onlyClose') {
      panel.standardWindowButton(NSWindowZoomButton).setHidden(true)
      panel.standardWindowButton(NSWindowMiniaturizeButton).setHidden(true)
      panel.standardWindowButton(NSWindowZoomButton).setEnabled(false)
    }
